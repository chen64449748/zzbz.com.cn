...
<script type="text/javascript">
  ...
  function price_pl(input_p) {
  
    $(input_p).parents('.ps_table').eq(0).find('.price').each(function () {
      $(this).val(input_p.value);
    });

  }

  function stock_pl(input_s) {
    $(input_s).parents('.ps_table').eq(0).find('.stock').each(function () {
      $(this).val(input_s.value);
    });
  }

  function code_pl(input_c) {
    $(input_c).parents('.ps_table').eq(0).find('.code').each(function () {
      $(this).val(input_c.value);
    });
  }
</script>
<body>
      ...
      <div class="menu-space">
        <div class="content">
          <div class="side-user">
            ...
            <div class="info">
              <a href="#">{{Session::get('manage')->tname}}</a>
